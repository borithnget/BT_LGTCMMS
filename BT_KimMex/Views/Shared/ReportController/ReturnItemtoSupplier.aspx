...
<head runat="server">
    <title>Return Item to Supplier Report</title>
    <script runat="server">
        void Page_Load(object sender,EventArgs s)
        {
            if (!IsPostBack)
            {
                ...
                string reportPath = Server.MapPath("~/Reports/ReturnItemtoSupplier.rdlc");
                ...
                BT_KimMex.Class.ReportHandler.GenerateReturnItemtoSupplierReport(this.ReportViewer1, reportPath, dateFrom, dateTo,status);
