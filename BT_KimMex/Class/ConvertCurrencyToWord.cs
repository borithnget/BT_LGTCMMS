...
{
    public class ConvertCurrencyToWord
    {
        public static String CurrencyToWord(string number)
        {
            string word = string.Empty;
            string isNegative = "";
            try
            {
                number = Convert.ToDouble(number).ToString("F");
            ...
            try
            {
                ...
                if (decimalPlace > 0)
                {
                    ...
                    if (Convert.ToInt32(points) > 0)
                    {
                        ...
                        //added by rith aug 17,2018
                        //if (points.ToString().Length == 1) points = Convert.ToInt32(points) * 10; //points =(Convert.ToInt32(points) * 10).ToString();
                        //pointStr = ConvertDecimals(points);
                        pointStr = SmallNumberToWord(Convert.ToInt32(points),"");
                    }
